"""
Django settings for GestSante project.
...
SECRET_KEY = 'django-insecure-_h7+he&mqu2+$vbhi)+1q^^w61l=ux165e5%isnjl&r0n-)=mr'
...
WSGI_APPLICATION = 'GestSante.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to Eva",

    # Copyright on the footer
    "copyright": "Dally-Morgan",

    # List of model admins to search from the search bar, search bar omitted if excluded
    # If you want to use a single search field you dont need to use a list, you can use a simple string 
    "search_model": ["auth.User", "auth.Group", "Gesci.Intervention"],
    ...
    "icons": {
        ...
        "Sante.Service": "fas fa-bed",
        "Sante.Appareil": "fas fa-stethoscope",
        "Sante.Hopital": "fas fa-hospital",
        "Sante.Medecin": "fas fa-user",
        "Sante.Patient": "fas fa-users",
...
THEMES = {
    # light themes
    "default": "vendor/bootswatch/darkly/bootstrap.min.css",
